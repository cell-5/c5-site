  ...
  render() {
    ...
    return (
      <div className="People">
        ...
        <Person 
          name="Peter" 
          title="Full-stack developer with specialisms in cloud architectures and devops." 
        ...
        <Person 
          name="Harry" 
          title="Full-stack developer with specialisms in front end architectures." 
          twitter="harrys twitter" 
